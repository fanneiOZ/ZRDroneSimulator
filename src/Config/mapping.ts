...
export const enum responseMessage {
    ...
    MoveRemoted         = '[REMOTED] Drone remoted moving to %direction% by %remoter%',
    Rotated             = 'Drone rotated to %rotation% toward the %direction%.',
    RotateRemoted       = '[REMOTED] Drone remoted rotating to %rotation% toward the %direction% by %remoter%',
    ...
    PlaceRemoted        = '[REMOTED] Drone remoted placing at %position% heading to %direction% by %remoter%.',
